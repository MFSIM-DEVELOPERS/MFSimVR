...
There are many ways of logging in ALVR, each one for different use-cases. To make use of them you should add `use mfsimvr_common::prelude::*` at the top of the Rust source file.
