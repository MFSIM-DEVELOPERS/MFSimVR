...
use mfsimvr_common::anyhow::Result;
use mfsimvr_common::{dbg_connection, error, warn};
use mfsimvr_session::WiredClientAutoLaunchConfig;
use mfsimvr_system_info::{
...
impl WiredConnection {
    pub fn new(
        layout: &mfsimvr_filesystem::Layout,
