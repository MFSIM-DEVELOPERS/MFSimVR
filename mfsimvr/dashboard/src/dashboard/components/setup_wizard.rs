...
impl SetupWizard {
    ...
    pub fn ui(&mut self, ui: &mut Ui) -> Option<SetupWizardRequest> {
        ...
        ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                ui.add_space(30.0);
                ui.heading(RichText::new("Welcome to MFSimVR").size(30.0));
                ui.add_space(5.0);
            });
        ...
        match &self.page {
            Page::Welcome => page_content(
                ui,
                "This setup wizard will help you setup MFSimVR.",
                "",
                |_| (),
            ),
            Page::ResetSettings => page_content(
                ui,
                "Reset settings",
                "It is recommended to reset your settings everytime you update MFSimVR.",
                |ui| {
            ...
            Page::HardwareRequirements => page_content(
                ...
                r"MFSimVR requires a dedicated and recent graphics card. Low-end Intel integrated graphics may fail to work.
...
This requires administrator rights!",
            ...
            Page::Recommendations => page_content(
                ui,
                "Recommendations",
                r"MFSimVR supports multiple types of PC hardware and headsets but not all might work correctly with default settings. Please try tweaking different settings like resolution, bitrate, encoder and others if your MFSimVR experience is not optimal.",
                |_| (),
            ),
