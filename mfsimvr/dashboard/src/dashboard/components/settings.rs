...
use mfsimvr_gui_common::{DisplayString, theme};
use mfsimvr_session::{SessionSettings, Settings};
...
impl SettingsTab {
    pub fn new() -> Self {
        ...
        let schema = Settings::schema(mfsimvr_session::session_settings_default());
