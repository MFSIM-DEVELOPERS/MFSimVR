...
use mfsimvr_gui_common::DisplayString;
use mfsimvr_packets::PathValuePair;
use mfsimvr_session::settings_schema::{ChoiceControlType, SchemaEntry, SchemaNode};
use eframe::{
...
impl Control {
    pub fn new(
        ...
        Self {
            ...
            combobox_id: mfsimvr_gui_common::get_id(),
        }
    }
    ...
    pub fn ui(
        ...
        ui.with_layout(Layout::left_to_right(Align::Center), |ui| {
            if matches!(&self.gui, ChoiceControlType::ButtonGroup) {
                if mfsimvr_gui_common::button_group_clicked(ui, &self.variant_labels, variant_mut) {
