...
use mfsimvr_events::{GraphStatistics, StatisticsSummary};
        ...
        self.draw_graph(
            ...
            |ui, stats| {
                ...
                Grid::new("latency_tooltip").num_columns(2).show(ui, |ui| {
                    ...
                    label(ui, "MFSimVR Latency", transmission_total_latency_s, theme::FG);
                    label(
                        ui,
                        "Client System (not MFSimVR latency)",
                        stats.vsync_queue_s,
                    ...
                    label(
                        ui,
                        "Game Render (not MFSimVR latency)",
                        stats.game_time_s,
                        RENDER_EXTERNAL_LABEL,
                    );
                });
