...
use mfsimvr_common::ConnectionState;
use mfsimvr_gui_common::theme::{self, log_colors};
use mfsimvr_packets::ClientConnectionsAction;
use mfsimvr_session::{ClientConnectionConfig, SessionConfig};
use mfsimvr_sockets::WIRED_CLIENT_HOSTNAME;
use eframe::{
                ...
                .show(ui, |ui| {
                    Grid::new(0).num_columns(2).show(ui, |ui| {
                        ui.horizontal(|ui| {
                            ...
                            ui.heading(
                                RichText::new(
                                    "MFSimVR requires running SteamVR! \
                ...
                Grid::new("wired-client")
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.with_layout(Layout::right_to_left(Align::Center), |ui| {
                            ...
                            if mfsimvr_gui_common::switch(ui, &mut wired).changed() {
                                if wired {
