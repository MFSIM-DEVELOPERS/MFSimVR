...
use mfsimvr_system_info::{ClientFlavor, ClientFlavorDefault, ClientFlavorDefaultVariant};
...
pub struct LoggingConfig {
    #[schema(strings(help = "Notification tips teach you how to use mfsimvr"))]
    ...
    SettingsDefault {
        ...
        connection: ConnectionConfigDefault {
            ...
            wired_client_type: ClientFlavorDefault {
                ...
                variant: if mfsimvr_common::is_stable() {
        ...
        extra: ExtraConfigDefault {
            ...
            open_setup_wizard: mfsimvr_common::is_stable() || mfsimvr_common::is_nightly(),
            hide_while_version: "".into(),
        },
    }
}
