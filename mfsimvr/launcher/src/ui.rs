...
use mfsimvr_gui_common::ModalButton;
use eframe::{
    egui::{
...
impl Launcher {
    pub fn new(
        ...
        mfsimvr_gui_common::theme::set_theme(&cc.egui_ctx);
    ...
    fn version_popup(
        ...
        let response = mfsimvr_gui_common::modal(
            ctx,
            "Add version",
            {
...
impl eframe::App for Launcher {
    fn ui(&mut self, ui: &mut Ui, _: &mut eframe::Frame) {
        ...
        CentralPanel::default().show_inside(ui, |ui| match &self.state {
            State::Default => {
                ui.with_layout(Layout::top_down(Align::Center), |ui| {
                    ui.label(RichText::new("MFSimVR Launcher").size(25.0).strong());
                    ...
                    for installation in &self.installations {
                        ...
                        Frame::group(ui.style())
                            .fill(mfsimvr_gui_common::theme::SECTION_BG)
